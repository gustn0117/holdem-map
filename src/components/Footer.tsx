      ...
      <div className="max-w-[1400px] mx-auto px-4 md:px-8 py-10">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8">
          <div className="col-span-2 md:col-span-2">
            ...
            <p className="text-muted text-sm leading-relaxed max-w-xs">전국 홀덤 매장 정보를 한눈에 확인하고, 가까운 매장을 찾아보세요.</p>
          </div>
          <div>
            <h4 className="text-surface font-bold mb-3 text-sm">서비스</h4>
            <div className="flex flex-col gap-2">
              ...
              <Link href="/jobs" className="text-muted hover:text-accent text-sm transition-colors">구인구직</Link>
              <Link href="/notices" className="text-muted hover:text-accent text-sm transition-colors">공지사항</Link>
            </div>
          </div>
          <div>
            <h4 className="text-surface font-bold mb-3 text-sm">문의</h4>
            <div className="flex flex-col gap-2">
          ...
          <div>
            <h4 className="text-surface font-bold mb-3 text-sm">커뮤니티</h4>
            <div className="flex flex-col gap-2">
        ...
        <div className="border-t border-border-custom mt-8 pt-6 flex flex-col md:flex-row items-center justify-between gap-3">
