...
export default function Footer() {
  return (
    <footer className="bg-primary border-t border-border-custom mt-auto relative noise">
      <div className="relative max-w-7xl mx-auto px-4 py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12">
          <div className="col-span-2 md:col-span-1">
            <Link href="/" className="gold-text-shine text-2xl font-black tracking-tight inline-block mb-5">홀덤맵</Link>
            <p className="text-muted text-sm leading-relaxed max-w-52">
              전국 홀덤 매장 정보를 한눈에 확인하고, 가까운 매장을 찾아보세요.
            </p>
          </div>
          <div>
            <h4 className="text-white font-bold mb-5 uppercase tracking-wider text-xs">서비스</h4>
          ...
          <div>
            <h4 className="text-white font-bold mb-5 uppercase tracking-wider text-xs">문의</h4>
            <div className="flex flex-col gap-3">
          ...
          <div>
            <h4 className="text-white font-bold mb-5 uppercase tracking-wider text-xs">커뮤니티</h4>
            <div className="flex flex-col gap-3">
