    ...
    <>
      <header className="sticky top-0 z-50 bg-white border-b border-border-custom">
        ...
        <div className="border-t border-border-custom px-4 py-2 bg-white">
          ...
          <Link href="/tournament" className="shrink-0 block hover:brightness-110 transition-all" aria-label="무료토너 · 선착순 참가권받기">
            <img src="/btn-tournament-mobile.gif" alt="무료토너 선착순 참가권받기"
              className="md:hidden block" width={180} height={30} style={{ width: 180, height: 30 }} />
            <img src="/btn-tournament-pc.gif" alt="무료토너 선착순 참가권받기"
              className="hidden md:block" width={230} height={36} style={{ width: 230, height: 36 }} />
          </Link>
          </div>
          <div className="md:hidden grid grid-cols-3 gap-1.5 mt-2">
            {[
              ...
              { href: "/pointshop", label: "포인트샵", icon: "M16 11V7a4 4 0 00-8 0v4M5 9h14l1 12H4L5 9z", bg: "bg-[#0d0d0d] hover:bg-black" },
            ].map((item) => (
              <Link key={item.href} href={item.href}
