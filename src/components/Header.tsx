    ...
    <>
      <header className="sticky top-0 z-50 bg-white border-b border-border-custom">
        ...
        <div className="border-t border-border-custom px-4 py-2 bg-white">
          ...
          <Link href="/tournament" className="shrink-0 btn-shimmer btn-bounce btn-glow text-white text-[10px] md:text-[12px] font-black py-2 md:py-2.5 px-3 md:px-4 rounded-full whitespace-nowrap flex items-center justify-center gap-1.5 relative overflow-hidden">
            ...
            <span className="drop-shadow relative z-10">무료토너 · 선착순 참가권받기</span>
          </Link>
          </div>
