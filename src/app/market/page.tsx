...
export default function MarketPage() {
  ...
  useEffect(() => {
    supabase.from("market_listings").select("*").eq("is_hidden", false).order("pinned_rank", { ascending: false }).order("is_featured", { ascending: false }).order("created_at", { ascending: false })
