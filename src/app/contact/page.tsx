    ...
    <div className="flex flex-col min-h-screen pb-16 md:pb-0">
      ...
      <main className="flex-1 max-w-2xl mx-auto px-4 py-12 w-full">
        <div className="text-center mb-12">
          <div className="w-18 h-18 bg-accent rounded-xl flex items-center justify-center mx-auto mb-6 shadow-md shadow-accent/25">
        ...
        <form onSubmit={handleSubmit} className="bg-card rounded-xl border border-border-custom p-8 md:p-10 space-y-6">
