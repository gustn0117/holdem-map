      ...
      <main className="w-full mx-auto px-5 md:px-10 py-8 flex-1" style={{ maxWidth: "1400px" }}>
        <div className="max-w-3xl mx-auto">
            ...
            <div className="p-6 md:p-8">
              ...
              <div className="flex items-center gap-3 text-sub text-[14px] mb-6">
                ...
                <div>
                  ...
                  {item.region && <p className="text-muted text-[12px]">📍 {item.region}</p>}
                </div>
              </div>
          ...
          <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4 text-[13px] text-yellow-800">
            ⚠️ 중고거래 유의사항: 홀덤맵KOREA는 상품 중개·정산에 관여하지 않습니다. 직거래 시 안전한 장소에서 물품을 확인한 후 거래하세요. 사기 의심 시 즉시 관리자에게 신고해주세요.
          </div>
        </div>
      </main>
      <Footer />
