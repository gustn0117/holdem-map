          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="grid grid-cols-2 gap-3 flex-1">
                <Link href="/jobs" className="rounded-2xl card-shadow bg-white p-4 hover:card-shadow-hover transition-all group flex flex-col">
                  <svg className="w-6 h-6 text-accent mb-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0z" /></svg>
                  <p className="text-surface font-bold text-[14px] mt-3">구인구직</p>
                  <p className="text-muted text-[12px]">딜러 · 서빙</p>
                </Link>
                <Link href="/contact" className="rounded-2xl bg-accent p-4 hover:bg-accent-hover transition-all flex flex-col">
                  <svg className="w-6 h-6 text-white/70 mb-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>
                  <p className="text-white font-bold text-[14px] mt-3">매장 등록</p>
                  <p className="text-white/60 text-[12px]">문의하기</p>
                </Link>
              </div>
            </div>
          </div>
