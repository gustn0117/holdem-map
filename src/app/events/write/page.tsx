    ...
    <div className="flex flex-col min-h-screen pb-16 md:pb-0 bg-bg">
      ...
      <main className="max-w-2xl mx-auto px-4 md:px-8 py-10 w-full">
        ...
        <div className="bg-amber-50 border border-amber-200 rounded-xl px-4 py-3 mb-8">
          <p className="text-amber-800 text-[13px] font-semibold inline-flex items-center gap-1.5"><svg className="w-4 h-4 shrink-0" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L1 21h22L12 2zm1 14h-2v2h2v-2zm0-6h-2v4h2v-4z"/></svg>검토 기간은 영업일 기준 1~2일 소요됩니다.</p>
        </div>
